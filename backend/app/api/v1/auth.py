...
def refresh():
    ...
    refresh_token = get_jwt()['jti'] # Normally we pass the raw token, but JWTManager handles it. 
    ...
    access_token = AuthService.refresh_access_token(current_user, request.headers.get('Authorization').split(" ")[1])
