      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 z-50 h-full w-full sm:w-[450px] bg-white dark:bg-[#0a0a0a] border-l border-slate-200 dark:border-slate-800 shadow-2xl overflow-y-auto"
          >
            {/* Header */}
            <div className="sticky top-0 z-10 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-indigo-500" />
                <h2 className="font-semibold text-lg text-slate-900 dark:text-white tracking-tight">Portfolio Showcase</h2>
              </div>
            ...
            <div className="p-6 space-y-8">
              ...
              <section className="space-y-3">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-semibold bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
                  <Award className="w-3.5 h-3.5" /> Project Status: Completed (v12.0)
                </div>
                <h3 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">FraudShield AI Enterprise</h3>
              ...
              <section className="space-y-4">
                ...
                <div className="p-4 bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/50 rounded-xl space-y-3">
              ...
              <div className="pt-6 border-t border-slate-200 dark:border-slate-800">
                <Button className="w-full gap-2 bg-slate-900 hover:bg-slate-800 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200" onClick={onClose}>
