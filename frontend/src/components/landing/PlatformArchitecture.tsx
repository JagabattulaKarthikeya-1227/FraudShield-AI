      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
        ...
        <div className="relative max-w-4xl mx-auto h-[550px] flex flex-col justify-between hidden md:flex">
          ...
          <div className="flex justify-between items-center w-full relative z-20">
            ...
            >
              ...
              <h4 className="text-white font-medium text-sm mb-1">Global Gateways</h4>
            ...
            >
              ...
              <h4 className="text-white font-medium text-sm mb-1">Event Streaming</h4>
            ...
            >
              ...
              <h4 className="text-white font-medium text-sm mb-1">Feature Store</h4>
          ...
          <div className="flex justify-center gap-16 w-full relative z-20">
            ...
            >
              ...
              <h4 className="text-white font-medium text-sm mb-1">Decision Webhooks</h4>
            ...
            >
              <Database className="w-6 h-6 text-zinc-100 mb-3" />
              <h4 className="text-white font-medium text-sm mb-1">Data Warehouse</h4>
        ...
        <div className="md:hidden flex flex-col gap-4">
          <div className="bg-zinc-900 p-6 rounded-2xl border border-zinc-800">
             ...
             <h4 className="text-white text-sm font-medium">Global Gateways</h4>
          </div>
          ...
          <div className="bg-zinc-900 p-6 rounded-2xl border border-zinc-800">
             ...
             <h4 className="text-white text-sm font-medium">Decision Webhooks</h4>
          </div>
        </div>
